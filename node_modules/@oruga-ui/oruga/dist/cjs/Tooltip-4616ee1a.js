...
var script = {
  ...
  props: {
    ...
    position: {
      type: String,
      default: () => {
        return helpers.getValueByPath(config.getOptions(), 'tooltip.position', 'top');
      },
    ...
    triggers: {
      type: Array,
      default: () => {
        return helpers.getValueByPath(config.getOptions(), 'tooltip.triggers', ['hover']);
      }
    },
    ...
    animation: {
      type: String,
      default: () => {
        return helpers.getValueByPath(config.getOptions(), 'tooltip.animation', 'fade');
      }
    },
